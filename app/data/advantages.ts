...
export const advantages: Advantage[] = [
  {
    ...
    titleZh: '6 年制造经验',
    desc: 'Six years of expertise in nutritional supplement manufacturing, trusted by brands across 30+ countries worldwide.',
    descZh: '六年营养补充剂制造专业经验,服务全球 30+ 国家的品牌客户。'
  },
  {
    icon: 'layers',
