...
export const milestones: Milestone[] = [
  ...
  { year: '2017', title: 'GMP Certified', titleZh: 'GMP 认证', desc: 'Obtained national GMP certification and expanded into softgel production.', descZh: '获得国家 GMP 认证,扩展软胶囊生产。' },
  { year: '2018', title: 'Global Export', titleZh: '全球出口', desc: 'Began exporting to Europe and North America; earned FDA facility registration.', descZh: '开始出口欧洲和北美;获得 FDA 工厂注册。' },
