...
// 轻量内联 SVG 图标库 —— 线性 stroke 风格，统一 24x24 viewBox
// 通过 name 属性选择图标，继承 currentColor
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'flow'">
      <rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /><path d="M10 6.5h4a3 3 0 0 1 3 3V14" />
    </template>
    ...
    <template v-else-if="name === 'flask'">
      <path d="M9 3h6" /><path d="M10 3v6.5L5 18a2 2 0 0 0 1.8 3h10.4A2 2 0 0 0 19 18l-5-8.5V3" /><path d="M7.5 14h9" />
    </template>
    ...
    <template v-else-if="name === 'ship'">
      <path d="M3 14l1.5 5.5a2 2 0 0 0 1.9 1.5h11.2a2 2 0 0 0 1.9-1.5L21 14" /><path d="M3 14h18" /><path d="M5 14V9a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v5" /><path d="M12 3v4" /><path d="M9 7h6" />
    </template>
    ...
    <template v-else-if="name === 'leaf'">
      <path d="M11 20A7 7 0 0 1 4 13c0-5 4-9 9-9h7v7a9 9 0 0 1-9 9z" /><path d="M4 20l6-6" />
    </template>
